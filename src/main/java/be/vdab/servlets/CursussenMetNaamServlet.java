...
/**
 * Servlet implementation class CursussenMetNaamServlet
 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		if (woord != null) {
			if (woord.isEmpty()) {
				...
				Iterable<Cursus> cursussen = cursusService.findByNaamContains(woord);
				if (! cursussen.iterator().hasNext()) {
					request.setAttribute("fouten", Arrays.asList(
